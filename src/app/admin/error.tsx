...
export default function Error({
  ...
  return (
    <div className="flex min-h-[40vh] flex-col items-center justify-center gap-4 px-6">
      <h2 className="text-xl font-semibold text-amber-900">後台錯誤</h2>
      ...
      <div className="flex gap-4">
        ...
        <Link href="/admin/login" className="rounded-lg border border-amber-700 px-4 py-2 font-medium text-amber-800 hover:bg-amber-50">
          返回登入
        </Link>
      </div>
    </div>
